...
public class Hole6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole2 = findViewById(R.id.nextHole6);
        prevHole = findViewById(R.id.prevHole5);
