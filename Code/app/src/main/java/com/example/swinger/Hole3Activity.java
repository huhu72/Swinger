...
public class Hole3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button par5;
    private Button par6;
    private ImageButton nextHole3;
    private ImageButton prevHole2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole3 = findViewById(R.id.nextHole3);
        prevHole2 = findViewById(R.id.prevHole2);
        ...
        prevHole2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                prevHole();
            }
