...
public class Hole16Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole = findViewById(R.id.nextHole16);
        prevHole = findViewById(R.id.prevHole15);
