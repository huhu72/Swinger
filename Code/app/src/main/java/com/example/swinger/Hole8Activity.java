...
public class Hole8Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole2 = findViewById(R.id.nextHole8);
        prevHole = findViewById(R.id.prevHole7);
