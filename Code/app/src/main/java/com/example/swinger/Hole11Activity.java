...
public class Hole11Activity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        par1 = findViewById(R.id.hole11_par1Btn);
        par2 = findViewById(R.id.hole11_par2Btn);
        par3 = findViewById(R.id.hole11_par3Btn);
        par4 = findViewById(R.id.hole11_par4Btn);
        par5 = findViewById(R.id.hole11_par5Btn);
        par6 = findViewById(R.id.hole11_par6Btn);
        player1 = findViewById(R.id.hole11_playerOne);
        parBtns = new Button[]{par1,par2,par3,par4,par5,par6};
        p1Hits = findViewById(R.id.hole11_player1Hits);
        p1score = findViewById(R.id.hole11_player1Score);
    ...
    public void nextHole(View view){
        Intent intent = new Intent(this, Hole12Activity.class);
    ...
    public void prevHole(View view){
        Intent intent = new Intent(this, Hole10Activity.class);
        player1Name = player1.getText().toString();
        intent.putExtra("player1Name", player1Name);
        intent.putExtra("player1Score", p1score.getText().toString());
        startActivity(intent);
