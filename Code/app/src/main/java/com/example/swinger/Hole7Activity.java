...
public class Hole7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole2 = findViewById(R.id.nextHole7);
        prevHole = findViewById(R.id.prevHole6);
