...
public class Hole12Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole = findViewById(R.id.nextHole12);
        prevHole = findViewById(R.id.prevHole11);
