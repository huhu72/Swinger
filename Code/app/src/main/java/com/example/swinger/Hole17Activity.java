...
public class Hole17Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole = findViewById(R.id.nextHole17);
        prevHole = findViewById(R.id.prevHole16);
