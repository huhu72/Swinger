...
public class Hole5Activity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        par1 = findViewById(R.id.hole5_par1Btn);
        par2 = findViewById(R.id.hole5_par2Btn);
        par3 = findViewById(R.id.hole5_par3Btn);
        par4 = findViewById(R.id.hole5_par4Btn);
        par5 = findViewById(R.id.hole5_par5Btn);
        par6 = findViewById(R.id.hole5_par6Btn);
        player1 = findViewById(R.id.hole5_playerOne);
        parBtns = new Button[]{par1,par2,par3,par4,par5,par6};
        p1Hits = findViewById(R.id.hole5_player1Hits);
        p1score = findViewById(R.id.hole5_player1Score);
