...
public class Hole4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button par5;
    private Button par6;
    private ImageButton nextHole4;
    private ImageButton prevHole3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextHole4 = findViewById(R.id.nextHole4);
        prevHole3 = findViewById(R.id.prevHole3);
        ...
        nextHole4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nextHole();
            }
        });
        prevHole3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                prevHole();
            }
